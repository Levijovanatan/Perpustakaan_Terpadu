        ...
        <div class="container-fluid" id="navbarContent">
          <ul class="nav navbar-nav mr-auto">
            <li class="navbar-brand" style="color: black;">
              ...
              <li>
              <a class="nav-link active" href="bukuku.php" style="color: black">Buku yang dipinjam<span class="sr-only"></span></a>
            </li>
            </li>
          </ul>
                        ...
                        <div class="flip-card">
                            <div class="flip-card-inner">
                              ...
                              <div class="flip-card-back">
                                  ...
                                  <a href="pinjam.php?id_buku='.$data['id_buku'].'" class="badge badge-warning" style="font-size:120%">Pinjam Buku</a>
                              </div>
                            </div>
                        </div>
                      </div> 
